	...
	Container for functions and classes
		...
		local function main()
			...
			Lib.Window = (function()
				...
				local theme = {
					MainColor1 = Color3.fromRGB(15,30,50),
					MainColor2 = Color3.fromRGB(20,40,70),
					Button = Color3.fromRGB(25,60,110)
				}
			...
			--[[checkbox.InputBegan:Connect(function(i)
				...
				local function new(style)
					local obj = setmetatable({
						...
						Style = style or 0,
						Colors = {
    Background = c3(20, 35, 55),          -- ทะเลเข้ม
    Primary = c3(60, 170, 230),           -- ฟ้าสด
    Secondary = c3(15, 25, 40),           -- น้ำเงินเข้มรอง
    Disabled = c3(80, 100, 120),          -- น้ำเงินเทาอ่อน
    DisabledBackground = c3(10, 18, 30),  -- โทนเข้มดำ-น้ำเงิน
    DisabledCheck = c3(120, 150, 170)     -- ฟ้าเทานุ่มๆ เห็นชัด
}
					},mt)
					initGui(obj)
					return obj
				...
				local function fromFrame(frame)
					local obj = setmetatable({
						...
						Disabled = false,
						Colors = {
	Background = c3(18, 32, 47),            -- น้ำเงินเข้มแบบทะเลลึก
	Primary = c3(72, 191, 227),             -- ฟ้าอ่อนสดใสเหมือนผิวน้ำ
	Secondary = c3(10, 20, 30),             -- น้ำเงินดำ (เงาใต้น้ำ)
	Disabled = c3(90, 110, 130),            -- ฟ้าเทา (ดูหม่นแบบหมอกทะเล)
	DisabledBackground = c3(12, 26, 40),    -- น้ำเงินหม่นเข้ม เหมาะสำหรับพื้นหลังปิดการใช้งาน
}
					},mt)
					initGui(obj,frame)
					return obj
...
DefaultSettings = (function()
	...
	return {
		...
		Theme = {
			...
			Main1 = rgb(15,30,55),
      Main2 = rgb(20,40,70),
      Outline1 = rgb(10,20,40),
      Outline2 = rgb(40,120,200),
      Outline3 = rgb(80,160,220),
      TextBox = rgb(18,35,60),
      Menu = rgb(12,25,50),
        ListSelection = rgb(0,120,255),
        Button = rgb(25,60,110),
        ButtonHover = rgb(35,80,140),
        ButtonPress = rgb(15,40,80),
        Highlight = rgb(0,180,255),
        Text = rgb(225,245,255),
        PlaceholderText = rgb(150,180,210),
        Important = rgb(255,80,80),
        ExplorerIconMap = "",
        MiscIconMap = "",
        Syntax = {
            Text = rgb(225,240,255),
            Background = rgb(12,25,45),
            Selection = rgb(255,255,255),
            SelectionBack = rgb(0,120,255),
            Operator = rgb(220,230,255),
            Number = rgb(80,170,255),
            String = rgb(140,220,255),
            Comment = rgb(90,120,150),
            Keyword = rgb(0,170,255),
            Error = rgb(255,90,90),
            FindBackground = rgb(0,140,220),
            MatchingWord = rgb(60,80,110),
            BuiltIn = rgb(90,200,255),
            CurrentLine = rgb(20,45,80),
            LocalMethod = rgb(255,255,200),
            LocalProperty = rgb(120,200,255),
            Nil = rgb(80,170,255),
            Bool = rgb(80,170,255),
            Function = rgb(0,170,255),
            Local = rgb(0,170,255),
            Self = rgb(0,170,255),
            FunctionName = rgb(255,255,200),
            Bracket = rgb(220,230,255),
        },
		}
	}
end)()
