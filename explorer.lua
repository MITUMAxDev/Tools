...
DefaultSettings = (function()
	...
	-- 1. ตารางรวมธีมทั้งหมด
	local Themes = {
		-- 0. ธีมเดิม (Original Dark) - ใช้เป็นค่าเริ่มต้น (Fallback)
		["Original Dark"] = {
			_Recurse = true,
			Main1 = rgb(52,52,52), Main2 = rgb(45,45,45), Outline1 = rgb(33,33,33), 
			Outline2 = rgb(55,55,55), Outline3 = rgb(30,30,30), TextBox = rgb(38,38,38), 
			Menu = rgb(32,32,32), ListSelection = rgb(11,90,175), Button = rgb(60,60,60), 
			ButtonHover = rgb(68,68,68), ButtonPress = rgb(40,40,40), Highlight = rgb(75,75,75), 
			Text = rgb(255,255,255), PlaceholderText = rgb(100,100,100), Important = rgb(255,0,0), 
		...
		-- 1. ธีม "Cyberpunk Neon" (ล้ำยุค นีออน)
		["Cyberpunk Neon"] = {
			_Recurse = true,
			Main1 = rgb(13, 2, 33), Main2 = rgb(33, 5, 66), Outline1 = rgb(0, 0, 0), Outline2 = rgb(50, 10, 80), 
			Outline3 = rgb(0, 0, 0), TextBox = rgb(10, 0, 20), Menu = rgb(5, 0, 15), 
			ListSelection = rgb(249, 0, 249), Button = rgb(30, 0, 60), ButtonHover = rgb(50, 0, 100), 
			ButtonPress = rgb(10, 0, 30), Highlight = rgb(150, 0, 200), Text = rgb(255, 255, 255), 
			PlaceholderText = rgb(150, 0, 150), Important = rgb(255, 0, 0), ExplorerIconMap = "", MiscIconMap = "",
			Syntax = { 
				Text = rgb(255, 255, 255), Background = rgb(0, 0, 0), Selection = rgb(255, 255, 255), 
				SelectionBack = rgb(249, 0, 249), Operator = rgb(255, 255, 255), Number = rgb(255, 165, 0), 
				String = rgb(0, 255, 255), Comment = rgb(100, 50, 150), Keyword = rgb(0, 249, 249), 
				Error = rgb(255, 0, 0), FindBackground = rgb(141,118,0), MatchingWord = rgb(85,85,85), 
				BuiltIn = rgb(173, 241, 149), CurrentLine = rgb(20, 0, 40), LocalMethod = rgb(255, 200, 255), 
				LocalProperty = rgb(150, 0, 255), Nil = rgb(255, 165, 0), Bool = rgb(255, 165, 0), 
				Function = rgb(0, 255, 255), Local = rgb(0, 255, 255), Self = rgb(0, 255, 255), 
				FunctionName = rgb(255, 200, 255), Bracket = rgb(255, 255, 255) 
			},
		},

		-- 2. ธีม "Gaming Red/Noir" (ดุดัน เกมมิ่ง)
		["Gaming Red/Noir"] = {
			_Recurse = true,
			Main1 = rgb(26, 26, 26), Main2 = rgb(40, 40, 40), Outline1 = rgb(10, 10, 10), Outline2 = rgb(60, 60, 60), 
			Outline3 = rgb(0, 0, 0), TextBox = rgb(20, 20, 20), Menu = rgb(15, 15, 15), 
			ListSelection = rgb(255, 0, 0), Button = rgb(50, 50, 50), ButtonHover = rgb(70, 70, 70), 
			ButtonPress = rgb(10, 10, 10), Highlight = rgb(80, 0, 0), Text = rgb(255, 255, 255), 
			PlaceholderText = rgb(100, 100, 100), Important = rgb(255, 50, 50), ExplorerIconMap = "", MiscIconMap = "",
			Syntax = { 
				Text = rgb(255, 255, 255), Background = rgb(0, 0, 0), Selection = rgb(255, 255, 255), 
				SelectionBack = rgb(255, 0, 0), Operator = rgb(255, 255, 255), Number = rgb(255, 100, 100), 
				String = rgb(173, 241, 149), Comment = rgb(102, 102, 102), Keyword = rgb(255, 50, 50), 
				Error = rgb(255, 0, 0), FindBackground = rgb(141,118,0), MatchingWord = rgb(85,85,85), 
				BuiltIn = rgb(132, 214, 247), CurrentLine = rgb(30, 0, 0), LocalMethod = rgb(253, 251, 172), 
				LocalProperty = rgb(97, 161, 241), Nil = rgb(255, 100, 100), Bool = rgb(255, 100, 100), 
				Function = rgb(255, 50, 50), Local = rgb(255, 50, 50), Self = rgb(255, 50, 50), 
				FunctionName = rgb(253, 251, 172), Bracket = rgb(255, 255, 255) 
			},
		},

		-- 3. ธีม "Urban Industrial" (สุขุม ดิบ)
		["Urban Industrial"] = {
			_Recurse = true,
			Main1 = rgb(74, 74, 74), Main2 = rgb(90, 122, 140), Outline1 = rgb(50, 50, 50), Outline2 = rgb(100, 100, 100), 
			Outline3 = rgb(60, 60, 60), TextBox = rgb(80, 80, 80), Menu = rgb(65, 65, 65), 
			ListSelection = rgb(183, 65, 14), Button = rgb(120, 120, 120), ButtonHover = rgb(140, 140, 140), 
			ButtonPress = rgb(90, 90, 90), Highlight = rgb(150, 150, 150), Text = rgb(245, 245, 245), 
			PlaceholderText = rgb(180, 180, 180), Important = rgb(255, 80, 80), ExplorerIconMap = "", MiscIconMap = "",
			Syntax = { 
				Text = rgb(245, 245, 245), Background = rgb(50, 50, 50), Selection = rgb(245, 245, 245), 
				SelectionBack = rgb(183, 65, 14), Operator = rgb(245, 245, 245), Number = rgb(255, 200, 0), 
				String = rgb(150, 220, 120), Comment = rgb(150, 150, 150), Keyword = rgb(107, 142, 35), 
				Error = rgb(255, 0, 0), FindBackground = rgb(141,118,0), MatchingWord = rgb(85,85,85), 
				BuiltIn = rgb(150, 200, 240), CurrentLine = rgb(60, 60, 60), LocalMethod = rgb(253, 251, 172), 
				LocalProperty = rgb(97, 161, 241), Nil = rgb(255, 200, 0), Bool = rgb(255, 200, 0), 
				Function = rgb(107, 142, 35), Local = rgb(107, 142, 35), Self = rgb(107, 142, 35), 
				FunctionName = rgb(253, 251, 172), Bracket = rgb(245, 245, 245) 
			},
		},

		-- 4. ธีม "Arctic Tech" (คลีน ทันสมัย)
		["Arctic Tech"] = {
			_Recurse = true,
			Main1 = rgb(248, 249, 250), Main2 = rgb(255, 255, 255), Outline1 = rgb(220, 220, 220), Outline2 = rgb(200, 200, 200), 
			Outline3 = rgb(230, 230, 230), TextBox = rgb(250, 250, 250), Menu = rgb(240, 240, 240), 
			ListSelection = rgb(132, 192, 231), Button = rgb(200, 200, 200), ButtonHover = rgb(215, 215, 215), 
			ButtonPress = rgb(180, 180, 180), Highlight = rgb(230, 230, 230), Text = rgb(33, 37, 41), 
			PlaceholderText = rgb(150, 150, 150), Important = rgb(200, 0, 0), ExplorerIconMap = "", MiscIconMap = "",
			Syntax = { 
				Text = rgb(33, 37, 41), Background = rgb(255, 255, 255), Selection = rgb(255, 255, 255), 
				SelectionBack = rgb(132, 192, 231), Operator = rgb(33, 37, 41), Number = rgb(150, 100, 0), 
				String = rgb(0, 150, 0), Comment = rgb(150, 150, 150), Keyword = rgb(11, 90, 175), 
				Error = rgb(255, 0, 0), FindBackground = rgb(141,118,0), MatchingWord = rgb(85,85,85), 
				BuiltIn = rgb(0, 100, 200), CurrentLine = rgb(240, 240, 240), LocalMethod = rgb(0, 50, 100), 
				LocalProperty = rgb(0, 120, 200), Nil = rgb(150, 100, 0), Bool = rgb(150, 100, 0), 
				Function = rgb(11, 90, 175), Local = rgb(11, 90, 175), Self = rgb(11, 90, 175), 
				FunctionName = rgb(0, 50, 100), Bracket = rgb(33, 37, 41) 
			},
		},
	}

	local function getCurrentTheme()
		-- อ่านค่าธีมจาก getgenv().Setting["Theme"] และกำหนดค่าเริ่มต้นเป็น "Original Dark" หากไม่พบ
		local themeName = (getgenv().Setting and getgenv().Setting["Theme"]) or "Original Dark"
		
		-- คืนค่าธีมที่ถูกเลือก ถ้าไม่พบชื่อธีม ให้คืนค่า "Original Dark"
		return Themes[themeName] or Themes["Original Dark"]
	end
	...
	return {
		...
		-- โหลดชุดสีตามค่าที่ตั้งไว้ใน getgenv().Setting["Theme"]
...
Main = (function()
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Discord: @mituma",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
