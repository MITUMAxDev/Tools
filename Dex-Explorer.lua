...
local function main()
  ...
  Explorer.InitRightClick = function()
    ...
    context:Register("CUT",{Name = "ตัด", IconMap = Explorer.MiscIcons, Icon = "Cut", DisabledIcon = "Cut_Disabled", Shortcut = "Ctrl+Z", OnClick = function()
    ...
    context:Register("COPY",{Name = "คัดลอก", IconMap = Explorer.MiscIcons, Icon = "Copy", DisabledIcon = "Copy_Disabled", Shortcut = "Ctrl+C", OnClick = function()
    ...
    context:Register("PASTE",{Name = "วางใส่ข้างใน", IconMap = Explorer.MiscIcons, Icon = "Paste", DisabledIcon = "Paste_Disabled", Shortcut = "Ctrl+Shift+V", OnClick = function()
      local sList = selection.List
      local newSelection = {}
      local count = 1
      for i = 1,#sList do
    ...
    context:Register("DUPLICATE",{Name = "ทำซ้ำ", IconMap = Explorer.MiscIcons, Icon = "Copy", DisabledIcon = "Copy_Disabled", Shortcut = "Ctrl+D", OnClick = function()
      local clone = game.Clone
      local sList = selection.List
      local newSelection = {}
      local count = 1
    ...
    context:Register("DELETE",{Name = "ลบ", IconMap = Explorer.MiscIcons, Icon = "Delete", DisabledIcon = "Delete_Disabled", Shortcut = "Del", OnClick = function()
    ...
    context:Register("RENAME",{Name = "แก้ไขชื่อ", IconMap = Explorer.MiscIcons, Icon = "Rename", DisabledIcon = "Rename_Disabled", Shortcut = "F2", OnClick = function()
      local sList = selection.List
      if sList[1] then
    ...
    context:Register("UNGROUP",{Name = "ยกเลิกกรุ๊ป", IconMap = Explorer.MiscIcons, Icon = "Ungroup", DisabledIcon = "Ungroup_Disabled", Shortcut = "Ctrl+U", OnClick = function()
      local newSelection = {}
      local count = 1
      local isa = game.IsA
    ...
    context:Register("SELECT_CHILDREN",{Name = "เลือกไฟล์ Children", IconMap = Explorer.MiscIcons, Icon = "SelectChildren", DisabledIcon = "SelectChildren_Disabled", OnClick = function()
      local newSelection = {}
      local count = 1
      local sList = selection.List
    ...
    context:Register("JUMP_TO_PARENT",{Name = "ไปหา Parent", IconMap = Explorer.MiscIcons, Icon = "JumpToParent", OnClick = function()
      local newSelection = {}
      local count = 1
      local sList = selection.List
    ...
    context:Register("TELEPORT_TO",{Name = "เทเลพอร์ตไปหา", IconMap = Explorer.MiscIcons, Icon = "TeleportTo", OnClick = function()
      local sList = selection.List
    ...
    local OldAnimation
    context:Register("PLAY_TWEEN",{Name = "เล่น Tween", IconMap = Explorer.MiscIcons, Icon = "Play", OnClick = function()
      local sList = selection.List
    ...
    local OldAnimation
    context:Register("LOAD_ANIMATION",{Name = "เล่นอนิเมชั่น", IconMap = Explorer.MiscIcons, Icon = "Play", OnClick = function()
      local sList = selection.List
    ...
    context:Register("STOP_ANIMATION",{Name = "หยุดอนิเมชั่น", IconMap = Explorer.MiscIcons, Icon = "Pause", OnClick = function()
      local sList = selection.List
    ...
    context:Register("EXPAND_ALL",{Name = "ขยายทั้งหมด", OnClick = function()
      local sList = selection.List
    ...
    context:Register("COLLAPSE_ALL",{Name = "ยุบทั้งหมด", OnClick = function()
      local sList = selection.List
    ...
    context:Register("CLEAR_SEARCH_AND_JUMP_TO",{Name = "ลบการค้นหาและไปที่ไฟล์นี้", OnClick = function()
      local newSelection = {}
      local count = 1
      local sList = selection.List
    ...
    context:Register("COPY_PATH",{Name = "คัดลอกเส้นทางไฟล์", IconMap = Explorer.ClassIcons, Icon = 50, OnClick = function()
      local sList = selection.List
      if #sList == 1 then
    ...
    context:Register("INSERT_OBJECT",{Name = "เพิ่ม Object", IconMap = Explorer.MiscIcons, Icon = "InsertObject", OnClick = function()
      local mouse = Main.Mouse
      local x,y = Explorer.LastRightClickX or mouse.X, Explorer.LastRightClickY or mouse.Y
      Explorer.InsertObjectContext:Show(x,y)
    end})

    context:Register("CALL_FUNCTION",{Name = "เรียกฟังก์ชั่น", IconMap = Explorer.ClassIcons, Icon = 66, OnClick = function()
      
    end})

    context:Register("GET_REFERENCES",{Name = "ดู Lua References", IconMap = Explorer.ClassIcons, Icon = 34, OnClick = function()
      
    end})
    
    context:Register("SAVE_INST",{Name = "เซฟไปที่ไฟล์", IconMap = Explorer.MiscIcons, Icon = "Save", OnClick = function()
    ...
    context:Register("VIEW_API",{Name = "ดูหน้า API", IconMap = Explorer.MiscIcons, Icon = "Reference", OnClick = function()
      
    end})
    
    context:Register("VIEW_OBJECT",{Name = "ดู Object (คลิ๊กขวาเพื่อรีเซ็ต)", IconMap = Explorer.ClassIcons, Icon = 5, OnClick = function()
      local sList = selection.List
      local isa = game.IsA
    ...
    context:Register("FIRE_TOUCHTRANSMITTER",{Name = "ยิง TouchTransmitter", IconMap = Explorer.ClassIcons, Icon = 37, OnClick = function()
    ...
    context:Register("FIRE_CLICKDETECTOR",{Name = "ยิง ClickDetector", IconMap = Explorer.ClassIcons, Icon = 41, OnClick = function()
      local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
      if not hrp then return end
      for _, v in ipairs(selection.List) do if v.Obj and v.Obj:IsA("ClickDetector") then fireclickdetector(v.Obj) end end
    end})

    context:Register("FIRE_PROXIMITYPROMPT",{Name = "ยิง ProximityPrompt", IconMap = Explorer.ClassIcons, Icon = 124, OnClick = function()
      local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
      if not hrp then return end
      for _, v in ipairs(selection.List) do if v.Obj and v.Obj:IsA("ProximityPrompt") then fireproximityprompt(v.Obj) end end
    end})

    context:Register("VIEW_SCRIPT",{Name = "ดูสคริปต์", IconMap = Explorer.MiscIcons, Icon = "ViewScript", OnClick = function()
      local scr = selection.List[1] and selection.List[1].Obj
      if scr then ScriptViewer.ViewScript(scr) end
    end})
    
    context:Register("SAVE_BYTECODE",{Name = "เซฟ ScriptBytecode ลงในไฟล์", IconMap = Explorer.MiscIcons, Icon = "Save", OnClick = function()
    ...
    context:Register("SELECT_CHARACTER",{Name = "เลือก Character", IconMap = Explorer.ClassIcons, Icon = 9, OnClick = function()
      local newSelection = {}
      local count = 1
      local sList = selection.List
      local isa = game.IsA
    ...
    context:Register("VIEW_PLAYER",{Name = "ดูผู้เล่น", IconMap = Explorer.ClassIcons, Icon = 5, OnClick = function()
      local newSelection = {}
      local count = 1
      local sList = selection.List
      local isa = game.IsA
    ...
    context:Register("SELECT_LOCAL_PLAYER",{Name = "เลือก Local Player", IconMap = Explorer.ClassIcons, Icon = 9, OnClick = function()
      pcall(function() if nodes[plr] then selection:Set(nodes[plr]) Explorer.ViewNode(nodes[plr]) end end)
    end})
    
    context:Register("SELECT_ALL_CHARACTERS",{Name = "เลือก Character ทั้งหมด", IconMap = Explorer.ClassIcons, Icon = 2, OnClick = function()
      local newSelection = {}
      local sList = selection.List
    ...
    context:Register("REFRESH_NIL",{Name = "รีเฟรช Nil Instances", OnClick = function()
      Explorer.RefreshNilInstances()
    end})
    
    context:Register("HIDE_NIL",{Name = "ซ่อน Nil Instances", OnClick = function()
...
Main = (function()
  ...
  Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
    local gui = create({
      ...
      {5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="สวัสดี " .. (game:GetService("Players").LocalPlayer.DisplayName or "User"),TextColor3=Color3.new(1,1,1),TextSize=20,TextTransparency=1,}},
      {6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="และดาบกูเฉือนฉับ",TextColor3=Color3.new(1,1,1),TextSize=18,TextTransparency=1,}},
      {7,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="StatusText",Parent={3},Position=UDim2.new(0,20,0,110),Size=UDim2.new(0,180,0,25),Text="มองแค่นี้ก็รู้แล้วครับว่าใครที่เหนือกว่า",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=1,}},
  ...
  Main.CreateMainGui = function()
    ...
    -- Create Main Apps
    Main.CreateApp({Name = "สำรวจไฟล์", IconMap = Main.LargeIcons, Icon = "Explorer", Open = true, Window = Explorer.Window})
    
    Main.CreateApp({Name = "ดูข้อมูลไฟล์", IconMap = Main.LargeIcons, Icon = "Properties", Open = true, Window = Properties.Window})
    
    Main.CreateApp({Name = "อ่านสคริปต์", IconMap = Main.LargeIcons, Icon = "Script_Viewer", Window = ScriptViewer.Window})
    
    local cptsOnMouseClick = nil
    Main.CreateApp({Name = "คลิ๊กเพื่อเลือก", IconMap = Main.LargeIcons, Icon = 6, OnClick = function(callback)
      if callback then
        local mouse = Main.Mouse
    ...
    Main.CreateApp({Name = "คลิ๊ก GUI เพื่อเลือก", IconMap = Main.LargeIcons, Icon = 6, OnClick = function(callback)
      if callback then
        local mouse = Main.Mouse
        local player = service.Players.LocalPlayer
  ...
  Main.Init = function()
    ...
    intro.SetProgress("รอแปปกำลังโหลดเวอร์ชั่น roblox",0.2)
    if Main.Elevated then
    ...
    -- Fetch external deps
    intro.SetProgress("โหลด API แปปนึง",0.35)
    API = Main.FetchAPI()
    Lib.FastWait()
    intro.SetProgress("โหลด RMD แปปนึง",0.5)
    RMD = Main.FetchRMD()
    Lib.FastWait()
    ...
    -- Load other modules
    intro.SetProgress("กำลังโหลด Modules",0.75)
    Main.AppControls.Lib.InitDeps(Main.GetInitDeps()) -- Missing deps now available
    Main.LoadModules()
    Lib.FastWait()
    
    -- Init other modules
    intro.SetProgress("กำลังเตรียม Modules",0.9)
    Explorer.Init()
    Properties.Init()
    ScriptViewer.Init()
    Lib.FastWait()
    ...
    -- Done
    intro.SetProgress("เสร็จละไอสัส",1)
    coroutine.wrap(function()
      Lib.FastWait(1.25)
      intro.Close()
    end)()
